...
Stable [releases](https://github.com/K-Jyotiraditya/whycon2/releases) are available periodically. Latest stable release can be downloaded by clicking [here](https://github.com/K-Jyotiraditya/whycon2/releases/latest). 
...
Please refer to the [wiki](https://github.com/K-Jyotiraditya/whycon2/wiki).
